...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  const { signInWithEmail, signInWithGoogle, sendPasswordReset, loading } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to Research & Methodology Simulator</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>© 2024 Research & Methodology Simulator. All rights reserved.</p>
        </div>
      </div>
